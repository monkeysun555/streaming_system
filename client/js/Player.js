...
(function (root, factory) {
  ...
  var Player = function(parOptions){
    ...
    var onPictureDecoded = function(buffer, width, height, infos) {
      ...
      // var decoded = Date.now();
      // var duration = decoded - start_decode;
      // console.log("decodeDuration" + duration);
      ...
      // var duration = rendered - decoded;
      // console.log("renderDuration" + duration);
    };
